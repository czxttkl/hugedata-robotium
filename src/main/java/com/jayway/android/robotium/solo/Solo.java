...
public class Solo {
	 ...
	 * @param message the message that should be displayed if the assert fails
	 * @param name the name of the {@link Activity} that is expected to be active e.g. {@code "MyActivity"}
	 * @param timeout the timeout for wait the activity
	 */
	
	public void assertCurrentActivity(String message, String name, int timeout)
	{	
		asserter.assertCurrentActivity(message, name, timeout);
	}
	
	/**
	 * Asserts that the expected Activity is the currently active one.
	 * If failed, the phone will take screenshots automatically.
	 * 
	 * @param message the message that should be displayed if the assert fails
	 * @param name the name of the {@link Activity} that is expected to be active e.g. {@code "MyActivity"}
	 * @param timeout the timeout for wait the activity
	 * @param takeScreenshot if true, take screenshot and save to files in /sdcard/Robotium-Screenshots
	 * 
	...
	/**
	 * Asserts that the view is shown in the current activity.
	 * @param message the message that should be displayed if the assert fails
	 * @param the View to be checked
	 * @timeout the timeout for the View to show up
	 * 
	 */
	 ...
	 * @param the View to be checked
	 * @timeout the timeout for the View to show up
	 * @takeScreenshot if true, take screenshots and save to files in /sdcard/Robotium-Screenshots
	 */

	public void assertViewShown(String message, View view, int timeout, boolean takeScreenshot)
	{
		if(takeScreenshot)
			asserter.assertViewShown(message, view, timeout, this);
		else
			asserter.assertViewShown(message, view, timeout);
	}
	...
	/** Use String id in the HierarchyViewer to locate a View
	 * 
	 * @param id the id String of a view you see in the HierarchyViewer
	 * @return
	 */
	...
	public void takeScreenshot(String name){
		...
		while(decorView == null){
			...
			Log.i("Robotium", name + (decorView == null?":null":":not null"));
		}
