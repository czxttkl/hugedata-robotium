...
class ScreenshotTaker {
	...
	public void takeScreenshot(final View view, final String name, final int quality) {
		//Log.i("Robotium", name + (view == null?":null":":not null"));
		//activityUtils.getCurrentActivity(false).runOnUiThread(new Runnable() {
		activityUtils.getCurrentActivity(true).runOnUiThread(new Runnable() {
			Bitmap  b;
			...
			public void run() {
				if(view !=null){
					...
					if(view instanceof WebView){
						Log.i("Robotium",name + ":WebView");
						b = getBitmapOfWebView((WebView) view);
					}
					else{
						Log.i("Robotium",name + ":BitView");
	...
	private Bitmap getBitmapOfWebView(final WebView webView){
		Log.i("Robotium","getBitmapOfWebView");
	...
	private Bitmap getBitmapOfView(final View view){
		Log.i("Robotium","getBitmapOfView");
		view.destroyDrawingCache();
