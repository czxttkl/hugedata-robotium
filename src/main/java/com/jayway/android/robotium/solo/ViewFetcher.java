	 ...
	 */
	 ...
	 private final View getRecentContainer(View[] views) {
		 ...
		 for(int i = 0; i < views.length; i++){
			 view = views[i];
			 if(view != null)
				 Log.i("Robotium", (view.isShown()?"view shown":"view hidden") + (view.hasWindowFocus()?"view focus":"view obscure") + " drawingTime:" + drawingTime + " view.getDrawingTime():" + view.getDrawingTime());
